...
document.body.appendChild(iframe); //把一个页面置空，把iframe放进去

//iframe.src = "https://www.w3.org/TR/2020/WD-css-position-3-20200519/"; 测试单个文件
...
function happen(element, event) {
    ...
    //调试 happen(document.body, "click").then(()=>Console.log("!!"))
}
